...
项目所需要的图片，icon图标（推荐：[阿里巴巴矢量图标库](https://www.iconfont.cn/)）自行获取，命名一致就行。
...
参考[在 vue3 中构建 SvgIcon 组件](https://blog.csdn.net/weixin_64684095/article/details/130991705?spm=1001.2014.3001.5501)
